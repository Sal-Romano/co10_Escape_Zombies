...
if (count A3E_ExtractionPositions == 0) then
{
	private _pos = [A3E_StartPos, 1000.0, 4000.0, 1.0, 0, 0.2, 0, [], _randomPos] call BIS_fnc_findSafePos;
	private _clear = [_pos,250,"all"] call A3E_fnc_CheckCampDistance;
	A3E_ExtractionPositions pushback [1,_pos,_clear,false,""];
};
