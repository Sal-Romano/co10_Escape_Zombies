...
private _instanceNo = 0;
{
	...
	if _ok then {
		...
		[_pos, _dir, a3e_arr_ComCenStaticWeapons, a3e_arr_ComCenParkedVehicles, a3e_arr_StaticAAWeapons] call 
			selectRandom [
				//a3e_fnc_BuildComCenter, //
				//a3e_fnc_BuildComCenter2, //
				//a3e_fnc_BuildComCenter3, // cement bunker
				//a3e_fnc_BuildComCenter4, // 
				//a3e_fnc_BuildComCenter5 // ??
				a3e_fnc_ToothBuildComCenter1,
				a3e_fnc_ToothBuildComCenter2
			];
...
private _enemyCount = [4.5] call A3E_fnc_GetEnemyCount;
_enemyCount params ["_minEnemies", "_maxEnemies"];

_playerGroup = [] call A3E_fnc_GetPlayerGroup;
[_playerGroup, "drn_CommunicationCenterPatrolMarker", A3E_VAR_Side_Opfor, "INS", 4, _minEnemies, _maxEnemies, _enemyMinSkill, _enemyMaxSkill, _enemySpawnDistance, A3E_Debug] call drn_fnc_InitGuardedLocations;
