...
player createDiaryRecord ["Diary", ["Intelligence Revealed", "OPFOR and the local military seem to know about the upcoming invasion, and are working hard on defensive preparations. They have stationed ammunition depots all over North Vietnam, as well as advanced communication centers guarded by heavy armor."]];
player createDiaryRecord ["Diary", ["Background", "Before the invasion of North Vietnam a group of highly skilled army specialists were sent into the heart of the enemy's territory. The goal of their mission was to gather intelligence, classified as top priority information, of OPFOR defensive structures. While the mission in itself was very successful and revealed even more useful information than hoped for, the withdrawal from North Vietnam was not. On the small and snaky roads of North Vietnam they made one single mistake and suddenly found themselves lost. If even just for a minute, it was enough to shortly thereafter run straight into a heavily guarded road block. Without a chance to fight they were caught and taken prisoners to a temporary outdoor prison already holding an engineer thought to be killed in a helicopter crash."]];
player createDiaryRecord ["Diary", ["Global Background", "BLUFOR has secretly and for some time been planning the invasion and liberation of North Vietnam beginning in a couple of weeks."]];
